...
var ServerClient_1 = require("./server/serverclient/ServerClient");
...
var client = new ServerClient_1.ServerClient(io);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client.CheckUserExists(username)];
                case 1:
                    if (!(_a.sent())) {
                        res.sendFile(__dirname + '/index.html');
                        return [2 /*return*/];
                    }
                    endpoint = "/chat?username=" + username;
